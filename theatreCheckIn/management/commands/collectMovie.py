...
from theatreCheckIn.management.commands import upcoming_cine_scope, upcoming_cine_scope_eigacom
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        movie_list = upcoming_cine_scope_eigacom.make_playing_movie_list()
